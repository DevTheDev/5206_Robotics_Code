...
#pragma config(Motor,  motorA,          IntakeR,       tmotorNXT, openLoop, encoder)
#pragma config(Motor,  motorB,          IntakeL,       tmotorNXT, openLoop, encoder)
#pragma config(Motor,  mtr_S1_C1_1,     driveR,        tmotorTetrix, openLoop, driveRight)
#pragma config(Motor,  mtr_S1_C1_2,     driveL,        tmotorTetrix, openLoop, reversed, driveLeft)
...
#define intakeBtn joy1Toggle(btnRT) || joy1Toggle(btnLT)
