...
#define gate_control_close joy2Btn(btnX)
#define gate_control_open joy2Btn(btnB)
...
#define goal_closed_btn joy2Btn(btnLT)
...
task main()
{
    ...
    while(1){
        ...
        */
        ...
        float lift_vel = joystick.joy2_y1*100.0/128.0;
        ...
        servo[goal] = goal_open + (goal_closed-goal_open)*goal_down;
        //===========================Gate Mechanism==========================
        if(gate_control_open){
            servo[gate] = 127+100;
        }
        else if (gate_control_close){
            servo[gate] = 127-100;
        }
        else{
            servo[gate] = 127;
